...
import {currentYear, getCurrentSeason, Season, seasons, winter} from "../constants";
        ...
        <>
            <div className="season-container">
                ...
                <span className="countdown">
                    {formatDistanceToNow(seasons[currentSeason].date.setFullYear(currentSeason === winter ? currentYear - 1 : currentYear))}
                </span>
            </div>
            <div>
